...
export default function Login() {
  ...
  // Se estiver carregando ou já estiver logado, não renderiza nada
  if (user) {
    return null;
  }
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Implementar login com email/senha quando disponível
      setError("Login com email/senha ainda não implementado");
    } catch (error) {
